	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" >
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php"><img src="assets/images/logo.png" alt="Gestion de mat"></a>
			</div>
	...
	<div class="container">
		...
		<div class="row">
			...
			<article class="col-sm-9 maincontent">
				...
				<p>
                    Veuillez utiliser ce formulaire pour nous contacter en cas de problème avec le site.
				</p>
				<br>
					<form>
						<div class="row">
