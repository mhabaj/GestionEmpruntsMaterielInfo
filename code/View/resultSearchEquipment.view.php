...
<a href="DetailEquipment.php?ref_equip=<?php if(isset($donnees['ref_equip']) && $donnees['ref_equip']!= null) echo $donnees['ref_equip'] ?>">
    <div class="panel panel-primary">
        <div class="panel-heading"><?php if(isset($donnees['name_equip']) && $donnees['name_equip']!= null) echo $donnees['name_equip']; ?></div>
        <div class="panel-body">
            <strong> Référence du matériel </strong> : <?php if(isset($donnees['ref_equip']) && $donnees['ref_equip']!= null) echo $donnees['ref_equip']; ?> <br/>
            ...
            <br/>
            <strong> Version </strong> : <?php if(isset($donnees['version_equip']) && $donnees['version_equip']!= null) echo $donnees['version_equip']; ?> <br/>
        </div>
    </div>
</a>
    </article>
