    ...
    if ($finalStatement->rowCount() > 0) {
        ...
        { ?>
            <div>
                ...
                <strong> Nom du matériel emprunté</strong> : <?php if (isset($donnees)) echo $donnees['name_equip']; ?> <br/>
                <strong> Id du matériel emprunté </strong> : <?php if (isset($donnees)) echo $donnees['id_device']; ?> <br/>
